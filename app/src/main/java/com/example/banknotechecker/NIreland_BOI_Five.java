...
public class NIreland_BOI_Five extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.nireland_boi_five);

        TextView fiverFront = findViewById(R.id.niBoiFiverFront);
        fiverFront.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImageView noteImage = findViewById(R.id.niBoiFiverImage);
                noteImage.setImageResource(R.drawable.ni_boi_five_front);

                TextView fiverBack1 = findViewById(R.id.niBoiFiverFront);
                fiverBack1.setTextSize(30);

                TextView fiverFront1 = findViewById(R.id.niBoiFiverBack);
        ...
        TextView fiverBack = findViewById(R.id.niBoiFiverBack);
        fiverBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImageView noteImage = findViewById(R.id.niBoiFiverImage);
                noteImage.setImageResource(R.drawable.ni_boi_five_back);
